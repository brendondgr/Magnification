...
already have one. Fake clients, no network / no real DB.

Compensation + industry recovery moved to the shared enrichment pass — see
tests/recommend/test_enrichment.py.
"""
