...
| --- | --- | --- |
| Jobs / Tracker | `jobs, tab, selectedId, search, page, dragOverCol` | `loadJobs`, `mapDbJob`, `toggleIgnore`, `markApplied`, `moveTo`, `toggleStatus` |
...
| **Profile** | `profileOpen, profile{interests_paragraph,skills,job_titles,keyword_groups,resume_text,...}, pf*Draft, pfBusy` | `openProfile`, `loadProfile`, `saveProfile`, `onResumeFile`, `rebuildProfile`, `pfSet` |
